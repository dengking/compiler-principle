...
In [computing](https://en.wikipedia.org/wiki/Computing "Computing"), **code generation** is part of the process chain of a [compiler](https://en.wikipedia.org/wiki/Compiler "Compiler"), in which an [intermediate representation](https://en.wikipedia.org/wiki/Intermediate_representation "Intermediate representation") of [source code](https://en.wikipedia.org/wiki/Source_code "Source code") is converted into a form (e.g., [machine code](https://en.wikipedia.org/wiki/Machine_code "Machine code")) that the target system can readily execute.
