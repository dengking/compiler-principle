...
> NOTE: 最后一段话"While the rule makes it explicit that the translation of $E$ is built up from the translations of $E_1$, $T$, and '$+$', it may be inefficient to implement the translation directly by manipulating strings"是承上启下的，它的具体含义参见
